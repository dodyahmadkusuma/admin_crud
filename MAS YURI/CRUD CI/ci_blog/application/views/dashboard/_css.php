<link rel="stylesheet" href="<?= base_url('dashboard/')?>bootstrap/css/bootstrap.min.css">
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url('dashboard/')?>plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url('dashboard/')?>plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?= base_url('dashboard/')?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('asset/')?>css/jquery.dataTables.min.css">
  <style type="text/css">
    .content-wrapper{
      padding-left: 35px;
      padding-top: 25px;
